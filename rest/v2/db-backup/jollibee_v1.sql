...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 05:01 AM
...
(7, 1, 'Chicken', '2024-12-10 15:09:22', 2024),
(8, 1, 'Burger', '2024-12-10 15:09:27', 2024),
(9, 1, 'Spaghetti', '2024-12-10 15:09:35', 2024),
(10, 1, 'Palabok', '2024-12-11 09:07:09', 2024),
(11, 1, 'Sides', '', 2024);
...
(2, 1, '', 'YumBurger Solo', 65, 8, '', 0),
(3, 0, '', 'Test', 0, 7, '', 2024),
(4, 1, '', 'test2', 245, 8, '', 0),
(5, 1, '', 'test4', 45, 8, '2024-12-11 09:38:00', 2024),
(7, 1, '', 'asd', 0, 0, '2024-12-11 09:44:38', 2024);
...
--
ALTER TABLE `jollibee_food`
  MODIFY `food_aid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
