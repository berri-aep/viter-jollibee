...
INSERT INTO `jollibee_adv` (`adv_aid`, `adv_is_active`, `adv_title`, `adv_image`, `adv_datetime`, `adv_created`) VALUES
...
INSERT INTO `jollibee_settings_role` (`role_aid`, `role_is_active`, `role_name`, `role_description`, `role_created`, `role_datetime`, `role_is_asd`) VALUES
