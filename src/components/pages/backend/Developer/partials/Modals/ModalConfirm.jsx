...
import { setIsArchive, setIsRestore } from "@/components/store/storeAction";
import { useMutation, useQueryClient } from "@tanstack/react-query";

const ModalConfirm = ({
  setIsRestore, setIsArchive,
  mysqlEndpoint,
  queryKey,
  item,
}) => {
        ...
        <div className="modal-main bg-primary absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[400px] w-full rounded-md border border-line">
          ...
          <div className="modal-body p-2 py-4">
            ...
            <div className="flex justify-end gap-3 mt-5">
              <button className="btn btn-warning-" onClick={handleYes}>Confirm</button>
