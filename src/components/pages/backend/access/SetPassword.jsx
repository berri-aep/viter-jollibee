              ...
              return (
                <Form>
                  ...
                  <ul className="space-y-3 mt-5">
                    ...
                    >
                      <CheckCircle2 size={16} stroke={lengthValidated ? "green" : "rgba(255,255,255,0.7)"} />
                    ...
                    >
                      <CheckCircle2 size={16} stroke={upperValidated ? "green" : "rgba(255,255,255,0.7)"} />
                      Atleast 1 Uppercase
                    </li>
                    <li
                      className={`flex gap-2 items-center text-sm opacity-50 transition-all duration-200 ${
                    ...
                    >
                      <CheckCircle2 size={16} stroke={lowerValidated ? "green" : "rgba(255,255,255,0.7)"} />
                      Atleast 1 Lowercase
                    </li>
                    <li
                      className={`flex gap-2 items-center text-sm opacity-50 transition-all duration-200 ${
                    ...
                    >
                      <CheckCircle2 size={16} stroke={numberValidated ? "green" : "rgba(255,255,255,0.7)"} />
                      Atleast 1 Number
                    </li>
                    <li
                      className={`flex gap-2 items-center text-sm opacity-50 transition-all duration-200 ${
                    ...
                    >
                      <CheckCircle2 size={16} stroke={specialValidated ? "green" : "rgba(255,255,255,0.7)"} />
                      Atleast 1 Special Character
                    </li>
                  </ul>
                  <button className="btn btn-accent w-full center-all mt-5" onClick={() => setSucces(true)} type="submit">
