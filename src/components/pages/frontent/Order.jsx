    ...
    <>
      ...
      <div className="grid grid-rows-[auto_,1fr_,auto] min-h-[calc(100vh-200px)]">
        ...
        <section className="grid grid-cols-[150px_1fr] bg-primary px-3">
          ...
          <main className="m-1 bg-white rounded-md h-[60.5vh] overflow-y-auto custom-scroll">
            <MenuList
              category={category}
              cartData={cartData}
        ...
        <div className="flex p-1 px-3 justify-between item-center bg-primary text-white">
          ...
          >
            {cartData.length > 0 && (
              <span className="absolute -top-2 -left-2 text-[12px] font-bold  bg-white text-primary rounded-full size-[20px] grid place-content-center">
                {cartData.length}
              </span>
            )}
            View Cart
